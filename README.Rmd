...
So far, the package has one function only: `read_data()`, which reads in the exported raw data from the metabolic cart. Currently, data from **COSMED** and **CORTEX** are supported. In case you have data from a different system, please contact me and I will be happy to add that to the function.

The package is still in its [experimental](https://www.tidyverse.org/lifecycle/#experimental) phase, do do not hesitate to open any issues and/or suggest improvements.
